...
const ExclusiveOffers = () => {
    return (
        <div className="flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 mt-20 pb-30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-10">
                {exclusiveOffers.map((item) => (
                    ...
                    >
                        ...
                        <button className="flex items-center gap-2 font-medium cursor-pointer max-md:mt-12 mt-4 mb-5">
                            <img
                                src={assets.arrowIcon}
                                alt="arrow-icon"
